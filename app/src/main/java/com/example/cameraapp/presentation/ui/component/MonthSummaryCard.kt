...
import com.example.cameraapp.CameraApp
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                SummaryItemCard("수입","${formatter.format(totalIncome)}원", Modifier
                    .padding(end = 4.dp)
                    .weight(1f))
                SummaryItemCard("지출", "${formatter.format(totalExpense)}원", Modifier
                        .padding(start = 4.dp)
                        .weight(1f))
            }
        }
